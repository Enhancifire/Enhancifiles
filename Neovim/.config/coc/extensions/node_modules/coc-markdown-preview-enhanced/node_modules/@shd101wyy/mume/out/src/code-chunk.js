...
exports.run = exports.compileLaTeX = void 0;
...
function compileLaTeX(content, fileDirectoryPath, normalizedAttributes) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, fs_extra_1.unlink)(texFilePath);
            return svgMarkdown;
        }
        catch (e) {
            yield (0, fs_extra_1.unlink)(texFilePath);
...
function run(content, fileDirectoryPath, cmd, normalizedAttributes, latexEngine = "pdflatex") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (cmd.match(/(la)?tex/) || cmd === "pdflatex") {
            const patchedAttributes = Object.assign(Object.assign({}, normalizedAttributes), { latex_engine: normalizedAttributes["latex_engine"] || latexEngine });
...
` + content;
        ...
        return yield new Promise((resolve, reject) => {
            const task = (0, child_process_1.spawn)(cmd, args, { cwd: fileDirectoryPath });
