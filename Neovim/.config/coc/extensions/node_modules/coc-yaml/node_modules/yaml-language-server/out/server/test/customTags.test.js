...
describe('Custom Tag tests Tests', () => {
    ...
    before(() => {
        ...
        const { languageService: langService, validationHandler: valHandler } = testHelper_1.setupLanguageService(languageSettingsSetup.languageSettings);
    ...
    describe('Test that validation does throw errors', function () {
        it('Error when custom tag is not available', (done) => {
            ...
            validator
                ...
                assert.deepEqual(result[0], verifyError_1.createExpectedError('Unresolved tag: !test', 0, 0, 0, 5));
            })
                .then(done, done);
        });
    });
