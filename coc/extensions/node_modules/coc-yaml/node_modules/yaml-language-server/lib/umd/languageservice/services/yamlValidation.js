...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver", "vscode-json-languageservice/lib/umd/services/jsonValidation", "../parser/jsonParser07", "../utils/textBuffer", "../parser/yaml-documents"], factory);
    }
    ...
    exports.yamlDiagToLSDiag = (yamlDiag, textDocument) => {
        ...
        const range = {
            start,
                ...
                ? vscode_languageserver_1.Position.create(start.line, new textBuffer_1.TextBuffer(textDocument).getLineLength(start.line))
